...
class nnInteractiveInferenceSession():
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        # nnU-Net >= 2.6 trainers receive plans/configuration managers;
        # legacy trainers use the architecture-description signature.
        # Keep both paths because released nnInteractive model bundles exist
        # with either dependency generation.
        trainer_signature = inspect.signature(trainer_class.build_network_architecture).parameters
        if "plans_manager" in trainer_signature:
